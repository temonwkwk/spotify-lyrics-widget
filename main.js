...
function createWindow() {
  win = new BrowserWindow({width:390,height:560,minWidth:300,minHeight:300,frame:false,transparent:true,alwaysOnTop:true,resizable:true,webPreferences:{preload:path.join(__dirname,'preload.js'),contextIsolation:true}});
