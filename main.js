...
function createWindow() {
  win = new BrowserWindow({width:360,height:205,frame:false,transparent:true,alwaysOnTop:true,resizable:false,webPreferences:{preload:path.join(__dirname,'preload.js'),contextIsolation:true}});
